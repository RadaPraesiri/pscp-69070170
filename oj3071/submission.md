...
```text
รับค่าเลขสองจำนวน A , B เป็นช่วงของตัวเลขทั้งสอง
รับค่าตัวเลข d ที่ใช้หารให้ได้เศษ r
พิมพ์จำนวนตัวเลขในช่วงที่สามารถหารด้วย d ได้เศษ r
```
...
```text
ให้ n แทนจำนวนตัวเลขที่สามารถหาร d ได้เศษ r
เช็คเงื่อนไขคำนวณถ้าเลขใน range(A,B+1) หาร d ได้เศษ r จะเพิ่มค่าให้ n
พิมพ์ n
```
...
```text
เหมือนแผนแรก เพราะถ้าตัวเลขนั้นเข้าเงื่อนไขจะเพิ่มค่าให้ n เลย ซึ่ง n บอกจำนวนตัวเลขที่ผ่านเงื่อนไข
```
...
```text
1ถึง1 (เลข1) หารด้วย1 ได้เศษ0 มี1จำนวนคือตัวเอง
```
