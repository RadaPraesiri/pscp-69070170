...
```text
รับจำนวนครั้งที่ใส่เครื่องหมาย เช็คเงื่อนไขถ้า + เพิ่ม10คะแนน ถ้า - ลด5คะแนน
```
...
```text
ให้ start เป็นคะแนนเริ่มต้นคือ0
วนลูปตามจำนวนค่าที่รับเข้ามา
รับค่าในลูป
ถ้า + เพิ่ม10คะแนน
ถ้า - ลด5คะแนน
พิมพ์คะแนนที่ผ่านการคำนวณ
```
...
```text
เหมือนแผนแรก เพราะคำนวณโดยแทนค่าเข้าตัวแปรเลย
```
