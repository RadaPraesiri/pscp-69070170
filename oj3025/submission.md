...
```text
โจทย์ให้เดือนในแต่ฤดูและวันที่ ที่ฤดูจะเปลี่ยน
input:
เลขของเดือนและวันที่
output:
ชื่อฤดูของเดือนและวันที่อยู่ในช่วงฤดูนั้น
```
...
```text
step1 : เช็คว่าเป็นเดือนที่3หารลงตัวและวันที่21 รึป่าว
step2 : ถ้าใช่เพิ่มไปอีก1เดือนเหมือนนับเป็นเดือนถัดไป สำหรับเปลี่ยนฤดู
step3  : ถ้าเดือนที่เพิ่มมากกว่า12 ให้นับเป็น1
step4 : สร้างเงื่อนไขเช็คลำดับของเดือนในฤดูนั้น
step5 : พิมพ์ชื่อฤดูที่เดือนนั้นๆอยู่ในช่วง
```
...
```text
คล้ายแผนแรก เพราะปรับในส่วนที่เช็คว่าเป็นวันที่21 แทนด้วยวันที่ที่มากกว่าเท่ากับ21 เนื่องจากวันที่มากกว่า21จะเปลี่ยนฤดู วันที่น้อยกว่าจะยังไม่เปลี่ยนฤดู ถ้าเทียบกับแผนแรกวันที่น้อยกว่าหรือมากกว่า21จะไม่เปลี่ยนฤดูเลย
```
...
```text
เช็คว่าแค่วันที่21อย่างเดียวจะยังไม่เปลี่ยนฤดูถ้าเดือนหาร3ไม่ลงตัว
```
...
```text
เป็นเดือนที่หาร3ลงตัว และเป็นวันที่21
```
...
```text
มีแค่เดือนที่เข้้าเงื่อนไขเปลี่ยนฤดู
