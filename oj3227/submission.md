...
```text
เช็คแต้มของไพ่และแบ่งกลุ่มไพ่ แล้วบอกชื่อเต็มของไพ่
```
...
```text
รับค่าแล้วเปลี่ยนตัวอัักษรทั้งหมดให้เป็นพิมพ์ใหญ่
สร้างตัวแปรแยกกลุ่มไพ่กับแต้มไพ่
ใช้ string slicing เช็คตัวอักษรลำดับสุดท้ายที่เป็นตัวบอกกลุ่ม เข้าเงื่อนไขเช็ค D H S C แล้วแทนค่าให้ตัวแปรกลุ่ม
เช็คว่าตัวแรกเป็นตัวอักษรหรือเลข
ถ้าเป็นเลขแทนค่าตัวแปรแต้ม
ถ้าเป็นตัวอักษรเช็ค A J Q K แล้วแทนค่าตัวแปรแต้ม
พิมพ์ตัวแปรแต้มตามด้วยตัวแปรกลุ่ม
```
...
```text
เหมือนแผนแรก ตัวอักษรแต่ละตำแหน่งเข้าเงื่อนไขแล้วจะเก็บค่าที่ตรงกับโจทย์ต้องการไว้แล้วค่อยพิมพ์ออกมา
```
