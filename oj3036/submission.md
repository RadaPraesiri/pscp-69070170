...
```text
การนับจำนวนกำแพงที่ต้องพัง และ patten เพิ่มจำนวนของชั้นห้อง
```
...
```text
ทำ patten ให้เป็นสูตรททางคณิตศาสตร์
```
...
```text
กำหนดจำนวนแถว ตัวสุดท้ายในแถว ค่าที่เพิ่มตามจำนวนห้องในแต่ละชั้น
ลูป
จำนวนห้องสุดท้ายในชั้น+จำนวนห้องที่จะเพิ่มในชั้นถัดไป
เพิ่มจำนวนแถว
เพิ่มจำนวนห้องที่ต้องเพิ่มในชั้นถัดไป
เช็ค patten ที่เป็นแถวเลขคู่หรือคี่ จากนั้นเช็คห้องเลขคู่หรือคี่
ซึ่งแถวที่เป็นเลขคู่ห้องเลขคู่ต้องพังกำแพง2รอบ
จำนวนกำแพงแถวเลขคู่ห้องเลขคี่พังกำแพงจากปกติ2รอบจะลดรอบที่ใช้1รอบ เป็น แถว*2-1
แถวเลขคี่ห้องเลขคี่ใช้ แถว*2-1
แถวเลขคี่ห้องเลขคู่ใช้ แถว*2
...
```text
บุคคลผู้น่ารักควรเคารพ
```

เขาช่วยอะไร

```text
ทำให้ patten ที่คิดออกมาเป็นสูตรคณิต
```
