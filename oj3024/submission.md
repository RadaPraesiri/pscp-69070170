...
```text
ถ้าคะแนนมากที่สุดห่างจากคะแนนที่น้อยสุดเกิน2คะแนน จะเป็น surprising
input:
คะแนนรวม
คะแนนมากที่สุด
output:
surprise ถ้าคะแนนมากสุดกัยน้อยสุดห่างเกิน2
not surprise ถ้าคะแนนมากสุดกับน้อยสุดห่างไม่เกิน2
```
...
```text
เอาคะแนนมากรวมมาลบกับคะแนนมากที่สุดก่อนเป็นคะแนนของ2คนที่เหลือ แล้วเอาคะแนนของอีก2คนมาลบคะแนนสูงสุดอีกทีเพราะสนใจแค่คะแนนที่มากสุดและน้อยสุด จากนั้นเช็คว่าคะแนนมากที่สุดและคะแนนน้อยที่สุดห่างกันเกิน2รีป่าว
```
...
```text
คล้ายแผนแรก เพราะแก้ในส่วนที่คะแนนโหวตไม่สามารถต่ำกว่า 0 ได้ โดยตั้งค่าคะแนนที่ต่ำกว่า0 ให้เป็น0 แล้วไปเทียบกับคะแนนมากที่สุด
```
...
```text
คะแนนสูงสุดและต่ำสุดห่างกันเกิน2
```
...
```text
คะแนนต่ำสุดและสูงสุดห่างกันไม่เกิน2
```
