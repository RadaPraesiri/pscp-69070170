...
```text
หาระยะห่างระหว่างจุดเริ่มต้น(0,0)กับ(x,y) และเทียบอัตราการขยายต่อวิจะได้ระยะเวลา
```
...
```text
รับค่า input ตามโจทย์ เข้า loop รับค่า(x,y)ตามจำนวน N คำขอ เข้าสูตรคำนวณระยะห่างจุดเริ่มต้นกับx,y เทียบอัตราขยายของหมึก
```
...
```text
ทดสอบขอบเขตล่างสุดที่เป็นไปได้
```
...
```text
บุคคลท่านหนึ่งผู้มีความน่ารัก
```

เขาช่วยอะไร

```text
แก้สูตรทางคณิตศาสตร์
```
