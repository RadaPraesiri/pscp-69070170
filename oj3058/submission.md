...
```text
รับค่าจำนวนอิฐก้อนเล็กและใหญ่ แล้วเช็คว่าพอที่จะใช้สร้างกำแพงหรือไม่ ถ้าไม่ตอบ-1 ถ้าสร้างได้ให้ใช้ระยะของอิฐก้อนใหญ่ที่รับเข้ามาลบกับความยาวกำแพงที่ต้องการ ถ้าระยะพอดีก็ไม่ต้องใช้อิฐก้อนเล็ก ถ้าไม่พอดี ดูว่าอิฐก้อนเล็กที่มีมากกว่าหรือเท่ากับระยะที่เหลือมั้ย ถ้ามีพอพิมพ์ระยะที่เหลือ(เพราะเราจะสร้างให้พอดีไม่ใช้อิฐเกิน) ถ้าอิฐก้อนเล็กน้อยกว่าระยะที่เหลือพิมพ์-1
```
...
```text
รับค่าเข้ามา
คำนวณระยะของอิฐก้อนใหญ่
ลบระยะอิฐก้อนใหญ่จากระยะกำแพง
ถ้าอิฐก้อนใหญ่เกินระยะเอาออก1ก้อน (ระยะกำแพง+5)
คำนวณระยะที่เหลือจากอิฐก้อนเล็ก
ถ้าระยะเหลือมากกว่า0 พิมพ์ -1 (อิฐไม่พอ)
```
...
```text
คำนวณอิฐก้อนใหญ่ที่ต้องใช้โดยเทียบ min(จำนวนอิฐใหญ่, ระยะกำแพง//5) กันไม่ใช้อิฐก้อนใหญ่เกินระยะกำแพง
คำนวณระยะที่เหลือโดย ระยะกำแพง - ระยะอิฐก้อนใหญ่ที่ใช้
เช็คถ้าจำนวนอิฐก้อนเล็กมากกว่าเท่ากับระยะให้พิมพ์ระยะที่เหลือ เพราะถือว่ามีค่าเท่ากับอิฐเล็กที่ทำให้สร้างได้พอดี
ถ้าจำนวนอิฐก้อนเล็กน้อยกว่าระยะที่เหลือพิมพ์ -1
```
...
```text
ระยะอิฐก้อนใหญ่พอดีกับระยะกำแพง
```
...
```text
เพื่อนเสนอวิธีใช้ min() เช็คจำนวนอิฐก้อนใหญ่ที่ต้องใช้
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดคำนวณระยะที่เหลือและเช็คเงื่อนไข
```
