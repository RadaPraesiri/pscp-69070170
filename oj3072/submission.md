...
```text
รับข้อความ นับจำนวนสระที่อยู่ในข้อความ พิมพ์จำนวนสระที่นับได้
```
...
```text
รับข้อความ
สร้าง List a,e,i,o,u (โจทย์ให้เก็บค่าเป็น array)
for loop เช็คอักษรทีละตัวในข้อความ
ถ้าเข้าเงื่อนไขว่าตัวอักษรนั้นๆเป็นสระ ให้ไปเก็บค่าใน list ของสระนั้น 
เช็คเงื่อนไขถ้า list ไม่ว่างให้พิมพ์ความยาวของ list
```
...
```text
เหมือนแผนแรก เพราะถ้าเข้าเงื่อนไขเก็บค่าสระแต่ละตัวเป็น1ค่าใน list
list นั้นจะไม่ว่างและพิมพ์ความยาวค่าที่เก็บไว้ทั้งหมดใน list นั้น
```
