...
```text
โจทย์ให้รับค่าอุณหภูมิในหน่วยหนึ่ง และต้องการอุณหภูมิในอีกหน่วย
input:
ตัวเลขอุณหภูมิ, หน่วยของตัวเลข, หน่วยของอุณหภูมิที่ต้องการ
output:
เลขของอุณหภูมิที่ต้องการ
```
...
```text
step1 :เช็คหน่วยที่รับเข้ามา
step2 :ใช้สูตรแปลงเลขอุณหภูมิที่รับเข้ามาให้เป็นหน่วย Celsius
step3 :เช็คหน่วยที่ต้องการ
step4 :ใช้เลขอุณหภูมิที่อยู่ในหน่วย Celsius เข้าสูตรแปลงเป็นหน่วยที่ต้องการ
step5 :พิมพ์เลขอุณหภูมิที่ต้องการ
```
...
```text
เหมือนแผนแรก เพราะใช้หน่วยนึงเป็นค่ากลางทำให้คำนวณสะดวกและ ไม่สับสนระหว่างหน่วยที่รับเข้ามากับหน่วยที่ต้องการ
```
