...
```text
ตำแหน่งของขวัญเริ่มจากคนที่1แล้ว +k
รอบถัดไป +k -n #ถ้าตำแหน่งของขวัญเกินจำนวนคนในวง เอาตำแหน่งลบจำนวนคนทั้งหมด ตำแหน่งของขวัญจะไม่เกินจำนวนคน
ถ้าลงที่1กับโจรให้หยุด(นับรวมโจรด้วย)
print จำนวนคนที่ได้ตรวจ
```
...
```text
ให้ตำแหน่งของขวัญเริ่มจากคนที่1 ส่งของขวัญไป k ลำดับ นับว่าคนถัดไปตรวจของขวัญคนแรก
เช็คเงื่อนไข ถ้าตำแหน่งของขวัญไม่ใช่คนที่1และโจร
ให้ส่งของขวัญต่อ ถ้าตำแหน่งของขวัญเกินจำนวนคนลบจำนวนคนออกจากตำแหน่ง และเพิ่มจำนวนคนตรวจของขวัญ
ถ้าโจรได้ตรวจของขวัญนับจำนวนที่โจรตรวจด้วย
```
...
```text
คล้ายแผนเดิม เพราะเพิ่มตรวจเคสที่คนที่1เป็นโจร
```
