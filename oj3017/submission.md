...
```text
Input:
ตัวเลขของค่าอาหารเท่านั้น

output:
ตัวเลขหลังรวมค่าอาหาร + ค่าบริการ + vat
...
```text
#input cost * (10/100) = service
รับ input ค่าอาหาร คูณ 10% ได้ค่าบริการ
#if service < 50 : cost +=50 or service > 1000 : cost +=1000
เช็คค่าบริการถ้าน้อยกว่า50บาท ให้คิดเป็น50บาท หรือมากกว่า1,000บาท ให้คิดเป็น1,000บาท
#cost * (7/100) = vat
เอาค่าอาหารที่รวมกับค่าบริการแล้วคิดรวมกับ vat7%
#print cost = service + vat :.2f
พิมพ์ค่าอาหารที่รวมค่าบริการและvatแล้ว แสดงผลทศนิยม2ตำแหน่ง
```
...
```text
Step 1: รับค่าอาหาร(จำนวนเต็ม)
Step 2: คำนวณค่าบริการ10% ของค่าอาหาร
Step 3: ตรวจว่าค่าบริการน้อยกว่าเท่ากับ50 ให้คิดค่าบริการเพิ่ม50 หรือ ค่าบริการมากกว่า1,000 ให้คิดค่าบริการ1,000
Step 4: รวมค่าบริการกับค่าอาหาร
Step 5: เพิ่มค่า vat จาก step4
Step 6: พิมพ์ยอดรวมทั้้งหมดเป็นทศนิยม2ตำแหน่ง
```
