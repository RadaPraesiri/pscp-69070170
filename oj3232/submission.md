...
```text
รับระยะกระโดด กับ เป้าหมาย ทุกครั้งที่กระโดดระยะจะลด2
ถ้ากระโดดถึงเปิ้าหมายให้พิมพ์ว่ากระโดดก่ีครั้ง แต่ถ้าไม่ถึงพิมพ์ -1
```
...
```text
สร้างตัวแปรนับรอบที่กระโดดและระยะทางที่กระโดดไป
ใช้ loop เช็คระยะทางที่กระโดดไปแล้วน้อยกว่าเป้าหมาย
ใน loop ใส่เงื่อนไขดักถ้าระยะมททางยีงน้อยกว่าเป้าหมายแต่ระยะกระโดดหมดแล้ว(<=0) ให้พิมพ์-1แล้วหยุดการทำงานของ loop
    ให้ระยะทางที่กระโดดไปแล้วเพิ่มค่าจากระยะกระโดดที่รับเข้ามา
    ลดระยะกระโดด-2 และเพิ่มจำนวนรอบที่กระโดดไปแล้ว
หลังจากออก loop(ระยะที่กระโดดไปมากกว่าเท่ากับเป้าหมาย) ให้พิมพ์จำนวนรอบที่กระโดดไป
```
...
```text
เหมือนแผนแรก แค่ปรับเปลี่ยนบรรทัดที่โค้ดทำงาน ให้เพิ่มค่าและลดค่าหลังจากเช็คเงื่อนไขที่กระโดดไม่ถึงเป้าหมาย เพราะถ้าระยะกระโดดลดไปก่อนจะทำให้รอบกระโดดขาดไป1รอบ และถ้านับจำนวนรอบก่อนจะทำให้เกิน1รอบ
```
