...
```text
รับค่าสองจำนวนเป็นระยะ แล้วหาตัวเลขที่เป็นจำนวนเฉพาะในระยะ
```
...
```text
สร้าง list เพื่อเก็บตัวเลขที่เป็นจำนวนเฉพาะ
เช็คจำนวนในระยะว่าเป็นจำนวนเฉพาะไหม
ถ้ามีตัวเลขใน list ให้พิมพ์ตัวเลขออกมา พร้อมจำนวนตัวเลข
ถ้าไม่มีจำนวนเฉพาะเลยพิมพ์แค่จำนวนตัวเลข คือ0
```
