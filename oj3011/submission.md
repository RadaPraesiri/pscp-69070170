...
```text
ให้ดูว่าสีที่รับมาผสมกันแล้วออกมาเป็นอะไร

Input:
รับค่าสี2สี

Output:
สีที่ผ่านการผสมจาก input/ error ถ้า input ไม่ใช่แม่สี

Constraints:
ต้องครอบคลุมทั้งการสลับลำดับสีที่รับค่ามา
```
...
```text
Step 1: รับค่าสี1,2 
Step 2: ตรวจว่าสีแรกเป็นแม่สีไหน
Step 3: ในเงื่อนไขของสีแรก ตรวจว่าสีที่สองเป็นสีอะไร
Step 4: พิมพ์สีที่เข้าเงื่อนไขการผสมแม่สี
Step 5: ถ้าสีที่1และ2ไม่ใช่แม่สี ให้พิมพ์Error
```
...
```text
คล้ายกับแผนแรก เนื่องจากแผนแรกใช้ if-elseif ที่เยอะเกินไปทำให้ปรับมาเช็คเงื่อนไขทั้ง2สีพร้อมกัน และได้รับความช่วยเหลือเพิ่มเติมหลังติด test case ที่input ไม่ได้มีแค่ capitalize
```
...
```text
ตรวจว่าสีสามารถเหมือนกันได้ และจะออกมาเป็นสีนั้นๆ
```
...
```text
ตรวจ input ที่ไม่ได้เป็น capitalize
```
...
```text
Ken ที่ไม่ใช่ Suteephat
```

เขาช่วยอะไร

```text
ใบ้ในส่วน test case ที่ไม่ได้เป็น capitalize
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดทั้งหมดแล้วเพิ่ม input().capitalize()
```
